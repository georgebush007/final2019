...
The P-value is 0.0001 which is less than 0.5 so we reject the null hypothesis and conclude that we have enough evidence to prove that the vaccine makes males more susceptible to contracting AIDS.
...
```{r}
barchartGC(~infected + treatment, data = filter (avast, LGBTQ == 'gay') , main= 'LGTBQ Population', type= 'percent')
```

this barchart shows among the LGBTQ population that contracted AIDS, more of them contracted AIDS while taking the vaccine than the LGBTQ population that contracted AIDS while taking the placebo so there is a vaccine effectiveness that makes LGBTQ more susceptible to contracting AIDS. 
...
The P-value is 0 which is less than 0.5 so we reject the null hypothesis and conclude that we have enough evidence to conclude that the vaccine makes LGBTQ poulation more susceptible to contracting AIDS.
